            ...
            <li className='mb-12'>
                <div className='group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50'>
                    ...
                    <div className='z-10 sm:order-2 sm:col-span-6'>
                        ...
                        <p className='mt-2 text-sm leading-normal'>
                        Un projet qui m&apos;a permis de me familiariser avec les base de données SQL et leur utilisation avec un ORM tel que Prisma. Gestion de l&apos;authentification grâce à Next-Auth ainsi que l&apos;utilisation des Server Actions de Next JS. 
                        </p>
                    </div>
                    <Image
                        alt='Build a Spotify Connected App Newline course marketing card'
                        ...
                        decoding='async'
                        data-nimg='1'
                        className='rounded border-2 border-slate-200/10 transition group-hover:border-slate-200/30 sm:order-1 sm:col-span-2 sm:translate-y-1 bg-white/50'
                        src={FullStack}
                    />
                </div>
            </li>
