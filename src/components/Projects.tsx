...
import Tarot from "../../public/Capture8.png";
      ...
      <ul className="group/list">
            ...
            <div className="z-10 sm:order-2 sm:col-span-6">
              <h3>
                <Link
                  ...
                  href="https://tarot-production-f5d1.up.railway.app/"
                  target="_blank"
              ...
              <p className="mt-2 text-sm leading-normal">
                Cette application est un jeu de tarot en ligne complet,
                respectant les règles officielles du tarot français. Ce projet
                ambitieux m&apos;a permis de mettre en œuvre mes compétences en
                développement web full-stack et de me familiariser avec des
                technologies modernes telles que Next.js, Prisma, Redux et les
                WebSockets.
              </p>
            </div>
            <Image
              alt="Jeu de tarot en ligne respectant les règles officielles"
              loading="lazy"
              width="200"
              height="48"
              decoding="async"
        ...
        <li className="mb-12">
          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
            ...
            <Image
              alt="Site e-commerce spécialisé dans la vente de fossilles Français et Marocains "
              loading="lazy"
              width="200"
              height="48"
              decoding="async"
        ...
        <li className="mb-12">
          <div className="group relative grid gap-4 pb-1 transition-all sm:grid-cols-8 sm:gap-8 md:gap-4 lg:hover:!opacity-100 lg:group-hover/list:opacity-50">
            ...
            <Image
              alt="Site Vitrine pour un restaurant situé à Quimper"
              loading="lazy"
              width="200"
              height="48"
              decoding="async"
